        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/programs' || pathname.includes('users')
                }
              >
                {(handleClick, open) => {
                  return (
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                  <path xmlns="http://www.w3.org/2000/svg" d="m0 9v9a5.006 5.006 0 0 0 5 5h14a5.006 5.006 0 0 0 5-5v-9zm14 10h-8a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2zm4-4h-12a1 1 0 0 1 0-2h12a1 1 0 0 1 0 2zm6-8v-1a5.006 5.006 0 0 0 -5-5h-14a5.006 5.006 0 0 0 -5 5v1zm-14-4a1 1 0 1 1 -1 1 1 1 0 0 1 1-1zm-3 0a1 1 0 1 1 -1 1 1 1 0 0 1 1-1zm-3 0a1 1 0 1 1 -1 1 1 1 0 0 1 1-1z"/>
                  </svg>
                       Programs
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
