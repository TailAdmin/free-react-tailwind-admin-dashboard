  ...
  return (
    <div className="static xl:relative">
      ...
      <Dropdown
        ...
        className="absolute !inset-s-0 !inset-e-auto top-full mt-4.25 flex h-120 w-[calc(100vw-2.5rem)] max-w-90.25 flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg xl:!inset-s-auto xl:!inset-e-0 dark:border-gray-800 dark:bg-gray-dark"
      >
